...
function runTasks() {
    ...
    */
    ...
    console.log(person_age > 18 || has_driving_license);
    var friends = ["Asif", "Ali", "Hasrat", "Ghulam Abbas"];
    console.log("is Ali is in friends list?");
    console.log(friends.indexOf("Ali") != -1);
    console.log("is Asif is in friends list?");
    ...
    */
    var usernames = ["Asif", "Ali", "Hasrat", "Ghulam Abbas", "admin"];
    ...
    var new_users = ["Asif", "Hassan", "Danish", "hassan", "Zulqarnain"];
